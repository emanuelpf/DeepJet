...
class TrainData_ParT(TrainData):
    def __init__(self):
        ...
        self.weight_binY = np.array(
            ...
            [-4.,-3.5,-3.,-2.5,-2.,-1.5,-1.,-0.5,0.5,1,1.5,2.,2.5,3.,3.5,4.], dtype=float) #Flat reweighting
        ...
        self.global_branches = ['jet_pt', 'jet_eta', 'jet_phi','jet_energy', # We add the jet_phi and jet_energy so we can build the pairwise features for the global jet as well.
                                'Jet_time', 
                                'nCpfcand','nNpfcand',
                                'nsv','npv',
   ...
   #                 stop = None,
    #                branches = branches
     #           )
            ...
            weighter.printHistos('/local/scratch/ssd1/epfeffer/sw/particletransformer/Flatten/') #If you need to print the 2D histo, choose your output dir
